...
function j({ debounce: n, scroll: t, polyfill: o, offsetSize: i } = { debounce: 0, scroll: false, offsetSize: false }) {
  ...
  const [c, h] = (0, import_react50.useState)({ left: 0, top: 0, width: 0, height: 0, bottom: 0, right: 0, x: 0, y: 0 }), e = (0, import_react50.useRef)({ element: null, scrollContainers: null, resizeObserver: null, lastBounds: c, orientationHandler: null }), d = n ? typeof n == "number" ? n : n.scroll : null, f = n ? typeof n == "number" ? n : n.resize : null, w = (0, import_react50.useRef)(false);
  (0, import_react50.useEffect)(() => (w.current = true, () => void (w.current = false)));
  const [z, m2, s] = (0, import_react50.useMemo)(() => {
    const r = () => {
  ...
  return X(s, !!t), W(m2), (0, import_react50.useEffect)(() => {
    v(), b();
  }, [t, s, m2]), (0, import_react50.useEffect)(() => v, []), [L, c, z];
}
function W(n) {
...
// node_modules/react-modal-sheet/dist/index.mjs
var SheetContext = (0, import_react52.createContext)(
  void 0
);
function useSheetContext() {
  const context = (0, import_react52.useContext)(SheetContext);
...
var SheetBackdrop = (0, import_react52.forwardRef)(
...
var SheetContainer = (0, import_react52.forwardRef)(
...
function useDragConstraints() {
  ...
  const onMeasure = (0, import_react52.useCallback)(() => constraints, []);
...
function useScrollPosition(options = {}) {
  ...
  const [scrollPosition, setScrollPosition] = (0, import_react52.useState)(void 0);
...
var SheetContent = (0, import_react52.forwardRef)(
  ({
    ...
    const disableScroll = typeof disableScrollProp === "function" ? disableScrollProp({
      scrollPosition: scroll2.scrollPosition,
      currentSnap: sheetContext.currentSnap
    }) : Boolean(disableScrollProp);
    const disableDragDueToScroll = !disableScroll && scroll2.scrollPosition && scroll2.scrollPosition !== "top";
    ...
    return import_react52.default.createElement(
      ...
      import_react52.default.createElement(
        motion.div,
        {
          ref: mergeRefs([scroll2.scrollRef, scrollRefProp]),
...
var SheetHeader = (0, import_react52.forwardRef)(
  ({ children, style, disableDrag, unstyled, className = "", ...rest }, ref) => {
    ...
    return import_react52.default.createElement(
      ...
      children || import_react52.default.createElement("div", { className: "react-modal-sheet-header", style: headerStyle }, import_react52.default.createElement(SheetDragIndicator, null))
    );
  }
);
SheetHeader.displayName = "SheetHeader";
var useIsomorphicLayoutEffect2 = IS_SSR ? import_react52.useEffect : import_react52.useLayoutEffect;
function useDimensions() {
  const [dimensions, setDimensions] = (0, import_react52.useState)(() => ({
...
function useSafeAreaInsets() {
  const [insets] = (0, import_react52.useState)(() => {
...
function useModalEffect({
  ...
  useIsomorphicLayoutEffect2(() => {
    ...
    const removeChangeListener = y.on("change", (yValue) => {
      if (!root) return;
      let progress2 = Math.max(0, 1 - yValue / sheetHeight);
      ...
      if (snapThresholdPoint !== void 0) {
        ...
        if (yValue <= snapThresholdValue) {
          progress2 = (snapThresholdValue - yValue) / snapThresholdValue;
        } else {
          progress2 = 0;
        }
      }
      if (startThreshold !== void 0) {
        ...
        if (yValue <= startThresholdValue) {
          progress2 = (startThresholdValue - yValue) / startThresholdValue;
        } else {
          progress2 = 0;
        }
      }
      ...
      const ty = transform(progress2, [0, 1], [0, 24 + insetTop]);
      const s = transform(progress2, [0, 1], [1, (pageWidth - 16) / pageWidth]);
...
function preventScrollStandard() {
  return chain(
    ...
    setStyle2(document.documentElement, "overflow", "hidden")
  );
}
function preventScrollMobileSafari() {
  ...
  const restoreStyles = chain(
    ...
    setStyle2(document.documentElement, "overflow", "hidden"),
    setStyle2(document.body, "marginTop", `-${scrollY}px`)
  );
  window.scrollTo(0, 0);
...
function setStyle2(element, style, value) {
...
function useStableCallback(handler) {
  const handlerRef = (0, import_react52.useRef)(void 0);
  useIsomorphicLayoutEffect2(() => {
...
function useSheetState({
  ...
  const [state, setState] = (0, import_react52.useState)(isOpen ? "opening" : "closed");
...
function useVirtualKeyboard(options = {}) {
  ...
  const focusedElementRef = (0, import_react52.useRef)(null);
  const debounceTimer = (0, import_react52.useRef)(null);
...
var Sheet = (0, import_react52.forwardRef)(
  ({
    avoidKeyboard = true,
    children,
    className = "",
    ...
    const [sheetBoundsRef, sheetBounds] = j();
    const sheetRef = (0, import_react52.useRef)(null);
    const sheetHeight = Math.round(sheetBounds.height);
    const [currentSnap, setCurrentSnap] = (0, import_react52.useState)(initialSnap);
    ...
    const sheet = import_react52.default.createElement(SheetContext.Provider, { value: context }, import_react52.default.createElement(
      motion.div,
      {
        ...rest,
        ref,
