    ...
    <div className="container relative z-10 -mt-12 mb-24 grid grid-cols-1 md:grid-cols-3 gap-8 px-6 md:px-12">
      {features.map((f, i) => (
        <BlurReveal key={i} delay={i * 0.2}>
          <div className="flex flex-col items-center text-center p-12 bg-background/40 backdrop-blur-3xl rounded-[3.5rem] border-4 border-foreground/5 hover:bg-primary transition-all duration-700 group scale-95 hover:scale-100 shadow-2xl shadow-transparent hover:shadow-primary/20">
