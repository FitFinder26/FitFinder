      ...
      >
        ...
        <div className="max-w-4xl space-y-12 text-center perspective-2000">
          <div className="space-y-8">
            ...
            <h1 className="text-5xl md:text-8xl lg:text-9xl font-black uppercase italic tracking-[-0.05em] leading-[0.8] text-foreground">
            ...
            <motion.p
              ...
              className="max-w-2xl mx-auto text-xl md:text-3xl font-bold italic tracking-tight leading-tight"
            >
              {t("hero.description")}
            </motion.p>
          </div>
          ...
          >
            {(device === "desktop" || isLoggedIn) ? (
              <Button
                ...
                className="group relative h-28 px-16 rounded-[3rem] bg-foreground text-background hover:bg-primary hover:text-white transition-all duration-700 overflow-hidden font-black text-2xl uppercase tracking-tighter w-full sm:w-auto shadow-2xl shadow-black/10 hover:shadow-primary/30"
              >
                <Camera size={36} className="me-6 transition-all duration-700 group-hover:rotate-12 group-hover:scale-125 group-hover:text-white" strokeWidth={2.5} />
              ...
              <Button
                ...
                className="h-28 px-20 rounded-[3rem] bg-secondary text-white hover:bg-primary transition-all duration-700 font-black text-3xl uppercase tracking-tighter w-full sm:w-auto shadow-2xl shadow-secondary/20 hover:shadow-primary/30"
              >
                {t("hero.join")}
              </Button>
            )}
            ...
            <Button
              ...
              className="h-28 px-16 rounded-[3rem] bg-transparent border-4 border-foreground/10 text-foreground hover:bg-foreground hover:text-background transition-all duration-700 font-black text-2xl uppercase tracking-tighter w-full sm:w-auto group"
            >
              {t("hero.demo")}
              <ChevronRight className="ms-4 transition-transform group-hover:translate-x-2 rtl:group-hover:-translate-x-2 rtl:-scale-x-100" size={32} strokeWidth={3} />
            </Button>
          </motion.div>
        </div>
      </motion.div>
